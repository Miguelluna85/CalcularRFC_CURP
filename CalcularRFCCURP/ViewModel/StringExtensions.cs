...
public static class StringExtensions
{
    ...
    public static bool EsVocal(char letraMayuscula)
    {
        if (letraMayuscula.Equals('A')
            || letraMayuscula.Equals('E')
            || letraMayuscula.Equals('I')
            || letraMayuscula.Equals('O')
            || letraMayuscula.Equals('U'))
            return true;
        else
            return false;
    }
    ...
    /// </summary>
    public static readonly HashSet<string> PalabrasInconvenientesCURP = new HashSet<string>
        {
            "BACA", "BAKA", "BUEI", "BUEY",
